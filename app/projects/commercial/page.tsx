...
export const metadata: Metadata = {
  title: "Commercial Projects | Orix Design Studio",
  description: "Commercial interior design projects by Orix Design Studio.",
};

const projects = allProjects.filter((p) => p.category === "Commercial");
    ...
    <div className="pt-24">
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
        ...
        <p className="mt-8 max-w-2xl text-lg text-[var(--foreground-muted)]">
          Offices, retail, and hospitality spaces that reflect your brand and
          elevate the experience of everyone who walks through the door.
        </p>
      </section>
